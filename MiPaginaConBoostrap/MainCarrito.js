    ...
    fetch('ProductosPagina.json')
        ...
        .then(productos => {
            ...
            productos.forEach(producto => {
                ...
                titulo.classList.add('tituloTeni');
                ...
                // Agregar la etiqueta de talla
                // Agregar la etiqueta de cantidad
                                const tallaParrafo = document.createElement('p');
                                tallaParrafo.textContent = `Talla: ${producto.talla}`;
                                productoDiv.appendChild(tallaParrafo);
                ...
                imagen.style.width = '100px'; // Ajusta el ancho de la imagen
                imagen.style.height = '100px'; // Ajusta el alto de la imagen
